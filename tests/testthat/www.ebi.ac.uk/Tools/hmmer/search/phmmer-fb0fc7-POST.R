structure(list(
  ...
  status_code = 400L, headers = structure(list(
    ...
    date = "Sun, 23 Oct 2022 16:29:19 GMT", `access-control-max-age` = "1000",
    expires = "Sun, 23 Oct 2022 16:29:19 GMT", `access-control-allow-origin` = "*",
    ...
    flag = FALSE, path = "/", secure = FALSE, expiration = structure(1667233759, class = c(
      "POSIXct",
      "POSIXt"
    ...
    NA,
    -1L
  ), class = "data.frame"), content = charToRaw("{\"seqdb\":[\"pfam is not a supported sequence database.\"]}"),
  date = structure(1666542559, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 5.8e-05,
    connect = 5.8e-05, pretransfer = 0.000195, starttransfer = 0.000198,
    total = 0.084633
  )
), class = "response")
