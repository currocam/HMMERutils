#' phmmer_2abl
#'
#' A DataFrame with 48 results of a phmmer search of the 2abl sequence.
#'
...
#' \item{\code{stats.nhits}}{The number of hits found above reporting thresholds}      
#' \item{\code{stats.elapsed}}{}
#' \item{\code{stats.Z}}{The number of sequences or models in the target database}          
...
#' \item{\code{stats.nincluded}}{The number of sequences or models scoring above the significance threshold}  
#' \item{\code{stats.n_past_vit}}{}
#' \item{\code{stats.nreported}}{The number of sequences or models scoring above the reporting threshold}  
...
#' \item{\code{hits.taxid}}{The NCBI taxonomy identifier of the target (if applicable)}       
...
#' \item{\code{hits.name}}{Name of the target (sequence for phmmer/hmmsearch, HMM for hmmscan)}        
#' \item{\code{hits.species}}{The species name of the target (if applicable)}
#' \item{\code{hits.score}}{Bit score of the sequence (all domains, without correction)}       
#' \item{\code{hits.bias}}{}
#' \item{\code{hits.sindex}}{}      
#' \item{\code{hits.nincluded}}{Number of domains satisfying inclusion thresholding}
#' \item{\code{hits.domains}}{The domain or hit hash contains the details of the match, in particular the alignment between the query and the target.}     
#' \item{\code{hits.pdbs}}{Array of pdb identifiers (which chains information)}
#' \item{\code{hits.evalue}}{E-value of the score}      
#' \item{\code{hits.nreported}}{Number of domains satisfying reporting thresholding}
#' \item{\code{hits.archindex}}{}   
#' \item{\code{hits.seqs}}{An array containing information about the 100\% redundant sequences}
#' \item{\code{hits.acc2}}{Secondary accession of the target}
#' }
#'
#' For further details, see \url{https://hmmer-web-docs.readthedocs.io/en/latest/appendices.html}
#'
"phmmer_2abl"