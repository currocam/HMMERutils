...
This is a basic example which shows you how to read HMMER files into HMMERutils' tidy DataFrame
...
Now, we can explore the e-values of the sequences we have obtained in search of red flags:
...
Observe how the sequences are clustered according to their percentage sequence identity and compare it with their phylogeny: 
...
```{r pairwise, dpi = 200, message=FALSE}
plot(
