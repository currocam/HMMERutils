...
`r Biocpkg("HMMERutils")` is based on many other packages and in particular in those that have implemented the infrastructure needed for dealing with RNA-seq data (EDIT!). That is, packages like `r Biocpkg("SummarizedExperiment")` (EDIT!).
...
* `r Biocpkg("HMMERutils")` `r Citep(bib[["HMMERutils"]])`
